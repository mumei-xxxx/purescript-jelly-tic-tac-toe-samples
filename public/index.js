(() => {
    ...
    return {
      ...
      useHooks: function(sig) {
        return bind32(ask3)(function(r) {
          return lift1(useHooks1(map3(flip(runReaderT)(r))(sig)));
        });
      },
  ...
  var monadHooksWriterTSignal = function(dictMonadHooks) {
    ...
    return function(dictMonoid) {
      ...
      return {
        ...
        useHooks: function(sig) {
          return bind32(lift1(useHooks1(map3(runWriterT)(sig))))(function(sigAW) {
            return discard33(tell1(join2(map3(snd)(sigAW))))(function() {
              return pure23(map3(fst)(sigAW));
            });
          });
        },
        MonadEffect0: function() {
  ...
  var boardComponent = function(dictComponent) {
    ...
    return bind4(newState2(replicate(9)(Nothing.value)))(function(v) {
      return bind4(newState2(true))(function(v1) {
  ...
  var pure5 = /* @__PURE__ */ pure(applicativeFn);
  ...
  var awaitDomContentLoaded = /* @__PURE__ */ makeAff(function(callback) {
    return function __do() {
      ...
      if (rs instanceof Loading) {
        ...
        var listener = eventListener(pure5(callback(new Right(unit))))();
  ...
  var discard32 = /* @__PURE__ */ discard5(bindHydrateM);
